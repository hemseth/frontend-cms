...
<template>
  <div class="h-[calc(100vh-80px)] overflow-hidden flex flex-col gap-4 p-4">
    ...
    <div v-if="status === 'pending'" class="flex-1 flex items-center justify-center bg-default/50 rounded-xl border border-dashed dark:border-gray-800">
    ...
    <div v-else-if="purchase" class="flex-1 min-h-0 bg-muted rounded-xl border dark:border-gray-800 p-2 overflow-hidden shadow-sm">
      <PurchasesPurchaseForm :initial-data="purchase" @success="onSuccess" @cancel="onCancel" />
    </div>

    <div v-else class="flex-1 flex flex-col items-center justify-center bg-default rounded-xl border dark:border-gray-800">
